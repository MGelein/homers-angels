...
$headerTemplate->replaceVars(array('htmlTitle' => "Homer's Angels - Media"));
echo $headerTemplate->display();

//render the main home content here
$homeTemplate = new Template('templates/media.html');
echo $homeTemplate->display();

//rendering the footer
$footerTemplate = new Template('templates/footer.html');
$footerTemplate->replaceVars(array('navID' => 'nav_media'));
